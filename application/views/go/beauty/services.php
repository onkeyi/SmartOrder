    ...
    <div id="content">
        ...
        <div class="sliderbg">
            <div class="pages_container">
                ...
                <blockquote>Design is the fundamental soul of a human-made creation that ends up expressing itself in
                    successive outer layers of the product or service. <span class="quote_author">-Steve Jobs</span>
                </blockquote>

                <h3>Our main services</h3>

                <div class="service_box">
                    <div class="services_icon"><img src="/assets/<?= $theme ?>/images/icons/services.png" alt=""
                                                    title=""/></div>
                    <div class="service_content">
                        <h4>Web development</h4>

                        <p>Lorem ipsum dolor sit <a href="#">amet consectetur</a> adipisicing elit, <strong>sed do
                                eiusmod</strong> tempor</p>
                    </div>
                </div>
                <div class="service_box">
                    <div class="services_icon"><img src="/assets/<?= $theme ?>/images/icons/layout.png" alt=""
                                                    title=""/></div>
                    <div class="service_content">
                        <h4>Layout design</h4>

                        <p>Cras <strong>vestibulum</strong> <a href="#">justo eget lorem</a> semper ac facilisis nulla
                            porta</p>
                    </div>
                </div>
                <div class="service_box">
                    <div class="services_icon"><img src="/assets/<?= $theme ?>/images/icons/pencil.png" alt=""
                                                    title=""/></div>
                    <div class="service_content">
                        <h4>Drawing</h4>
                ...
                <div class="service_box">
                    <div class="services_icon"><img src="/assets/<?= $theme ?>/images/icons/code.png" alt="" title=""/>
                    </div>
                    <div class="service_content">
                        <h4>Programming</h4>
                ...
                <div class="service_box">
                    <div class="services_icon"><img src="/assets/<?= $theme ?>/images/icons/travel.png" alt=""
                                                    title=""/></div>
                    <div class="service_content">
                        <h4>Custom work</h4>
                ...
                <div class="service_box">
                    <div class="services_icon"><img src="/assets/<?= $theme ?>/images/icons/security.png" alt=""
                                                    title=""/></div>
                    <div class="service_content">
                        <h4>Security</h4>
