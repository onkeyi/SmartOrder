    ...
    <div id="content">
        ...
        <div class="sliderbg">
            <div class="pages_container">
                <h2 class="page_title">おすすめ</h2>

                <div class="image_single radius4"><img src="/assets/<?= $theme; ?>/images/page_photo.jpg" alt=""
                                                       title="" border="0"/></div>
                ...
                <div id="tab3" class="tabcontent">
                    <h4>Quote title</h4>
                    <blockquote>Design is the fundamental soul of a human-made creation that ends up expressing itself
                        in successive outer layers of the product or service. <span
                            class="quote_author">-Steve Jobs</span></blockquote>
                </div>

                <h2>Some buttons styles</h2>
                <a href="#" class="button_12 green green_borderbottom radius4">Button 1/2</a>
                <a href="#" class="button_12 blue blue_borderbottom radius4">Button 1/2</a>
                <a href="#" class="button_12 red red_borderbottom radius4">Button 1/2</a>
                <a href="#" class="button_12 orange orange_borderbottom radius4">Button 1/2</a>
                <a href="#" class="button_12 black black_borderbottom radius4">Button 1/2</a>
                <a href="#" class="button_12 gray gray_borderbottom radius4">Button1/2</a>
                ...
                <div class="scrolltop radius20"><a onClick="jQuery('html, body').animate( { scrollTop: 0 }, 'slow' );"
                            ...
                            src="<?= $theme; ?>/images/icons/top.png"
                            alt="Go on top"
                            title="Go on top"/></a></div>
            </div>
